...
#define MEASURE_FREQ  0.5f	    //4Hz
#define FIFO_THRESHOLD	4		//generate FIFO threshold interrupt every 1 data.
...
void AD5940_PrintResult(void){
  ...
  for(i=0; i<data_count; i++){
    ...
    data = data/8.13f/1.5f-273.15f;
    
    *(uint32_t*)(bufor1) = index++;
    *(int32_t*)(bufor2) = data;
...
void AD5940_Temperature_Main(void){
  AD5940PlatformCfg();
